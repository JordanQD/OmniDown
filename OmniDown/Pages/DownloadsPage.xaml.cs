...
public sealed partial class DownloadsPage : Page
{
    ...
    public AppBarButton TaskDetailsButton => _taskDetailsButton;
    ...
    public AppBarToggleButton TaskFilterButton => _taskFilterButton;
    public Grid TaskFilterPanel => _taskFilterPanel;
    public Grid TaskCategoryFilterPanel => _taskCategoryFilterPanel;
    public TokenView TaskStatusFilterTokenView => _taskStatusFilterTokenView;
    public TokenView TaskCategoryFilterTokenView => _taskCategoryFilterTokenView;
    ...
    public event RoutedEventHandler? TaskFilterButtonClick;
    public event SelectionChangedEventHandler? TaskStatusFilterSelectionChanged;
    public event SelectionChangedEventHandler? TaskCategoryFilterSelectionChanged;
    ...
    private void TaskFilterButton_Click(object sender, RoutedEventArgs e) => TaskFilterButtonClick?.Invoke(sender, e);
    private void TaskStatusFilterTokenView_SelectionChanged(object sender, SelectionChangedEventArgs e) => TaskStatusFilterSelectionChanged?.Invoke(sender, e);
    private void TaskCategoryFilterTokenView_SelectionChanged(object sender, SelectionChangedEventArgs e) => TaskCategoryFilterSelectionChanged?.Invoke(sender, e);
